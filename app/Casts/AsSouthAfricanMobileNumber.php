...
/**
 * Casts a string to an instance of \App\ValueObjects\SouthAfricanMobileNumber.
 *
 ...
 */
class AsSouthAfricanMobileNumber implements CastsAttributes
{
    /**
    ...
    {
        return new SouthAfricanMobileNumber($value);
    }
